...
const AlbumImage = (props) => (
  <td style={{padding: 0, lineHeight: 0}}>
    <a href={props.href}>
      <img src={props.src} alt={props.title} title={props.title} width={props.width} height={props.height} style={{width: "100%", height: "auto"}} />
    </a>
  </td>
)
...
export default () => (
  <Layout canonicalLink="/">
    <Container style={{paddingTop: 7, paddingBottom: 15, color: "white", backgroundColor: "#325c80"}}>
      ...
      <p style={{fontWeight: 100}}>Here you will find some interesting stuff! Although there are not too many things, you can take a look around.</p>
    </Container>
    <Container style={{paddingTop: 20, paddingBottom: 20, backgroundColor: "white"}}>
      <table style={{borderSpacing: 2, width: "100%"}} className={[styles.collapse, styles.table].join(' ') }>
        <tbody>
          <tr>
            <AlbumImage src={p1} href={"https://www.flickr.com/photos/bogolyandras/14361853906"} title={"Sleeping Kitten"} width={320} height={180} />
            <AlbumImage src={p2} href={"https://www.flickr.com/photos/bogolyandras/13543664355"} title={"Aranyfa by András Bögöly, on Flickr"} width={320} height={180} />
            <AlbumImage src={p3} href={"https://www.flickr.com/photos/bogolyandras/13454067423"} title={"Waterfall by András Bögöly, on Flickr"} width={320} height={180} />
          </tr>
          <tr>
            <AlbumImage src={p4} href={"https://www.flickr.com/photos/bogolyandras/13842086385"} title={"Salad"} width={320} height={240} />
            <AlbumImage src={p5} href={"https://www.flickr.com/photos/bogolyandras/14592209397"} title={"Niederösterreich"} width={320} height={240} />
            <AlbumImage src={p6} href={"https://www.flickr.com/photos/bogolyandras/13364086264"} title={"Wagrain Mountains by András Bögöly, on Flickr"} width={320} height={240} />
          </tr>
        </tbody>
      </table>
    </Container>
